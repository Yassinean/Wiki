...
class Categories
{
    ...
    public function insertCategorie()
    {
        ...
        $sql = db::connect()->prepare("INSERT INTO categories (name) VALUES (:name)");
    ...
    public function updateCategorie()
    {
        ...
        $nom_categorie = $this->getNomCategorie();
        $sql = db::connect()->prepare("UPDATE categories SET name = :name WHERE id = :id_categories");
    ...
    {
        $id_categorie = $this->getIdCategorie(); 
        $sql = db::connect()->prepare("DELETE FROM categories where id = :id");
        $sql->bindParam(':id', $id_categorie);
        $sql->execute();
    } 
    ...
    public function selectCategoriesByID(){
        $id_categorie=$this->getIdCategorie(); 
        $sql = db::connect()->prepare("SELECT FROM categories WHERE id = :id ");
        $sql->bindParam(':id', $id_categorie);
        $sql->execute();
