        ...
        <div class="container mt-5">
            <div class="row">
                    ...
                    <article>
                        ...
                        <header class="mb-4">
                            <h1 class="fw-bolder mb-1"><?= $singles['title'] ?></h1>
                            <div class="text-muted fst-italic mb-2"><?=$singles['name'] ?></br>
                            <?=$singles['date_created'] ?></div>
                         
                        </header>
                       <div class="row gap-5" >
                        <img class="rounded mb-4 col-sm" src="<?=$singles['imageWiki'] ?>" alt="" height="100%" width="100%" />
                        <p class="fs-5 mb-4 col-sm "><?=$singles['content'] ?></p>
                       </div>
