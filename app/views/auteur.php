        ...
        <div class="main">
            <nav class="navbar navbar-expand border-bottom d-flex justify-content-between">
                ...
                <div class="d-flex">
                    ...
                    <img src="../../public/images/wp9403174.jpg" alt="" class="rounded-circle " width="40px" height="40px">
                                                ...
                                                <div style="max-height: 60px; overflow-y: auto;">
                                                    <?php foreach ($resultt as $tag) { ?>
                                                        <div class="form-check">
                                                            <label>
                                                                <input type="checkbox" name="options[]" value="<?= $tag['id'] ?>">
                                                                <a href="?id=<?= $tag['id'] ?>">
                                                                    <?= $tag["name"] ?>
                                                                </a>
                                                            </label>
                                ...
                                <div class="col-md-4 mb-4">
                                    <div class="card h-100">
                                        <div class="view overlay">
                                            <img class="card-img-top " src="<?= $wiki['imageWiki'] ?>" height="200px" alt="Card image cap">
                                        </div>
                                        <div class="card-body elegant-color white-text">
                                            <h4 class="card-title"><?= $wiki['title'] ?></h4>
                                            <p class="card-text white-text"> <?= substr($wiki['content'], 0, 100)  ?>...</p>
                                            <div class="d-flex justify-content-around ">
                                                <button value="<?= $wiki['id'] ?>" class="updateHidden btn btn-warning update-btn" data-bs-toggle="modal" data-bs-target="#modifierModal">
                                                    <i class="fa-solid fa-pen"></i>
                                                </button>

                                                <a href="auteur.php?id_d=<?= $wiki['id'] ?>" class="btn btn-danger">
