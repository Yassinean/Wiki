    ...
    <div class="wrapper">
        ...
        <div class="main">
            <nav class="navbar navbar-expand border-bottom d-flex justify-content-between">
                ...
                <div class="d-flex">
                    <img src="../../public/images/admin.jpg" alt="" class="rounded-circle " width="40px" height="40px">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button value="<?= $res['id'] ?>" class="updateHidden btn btn-warning update-btn" data-bs-toggle="modal" data-bs-target="#modifierModal">
                                                <i class="fa-solid fa-pen"></i>
                                            </button>
                                        </td>
                                        <td>
                                            <a href="tags.php?id_d=<?=$res['id']?>" class="btn btn-danger">
