                                        ...
                                        <tbody>
                                           ...
                                           ?> 
                                            <tr>
                                                ...
                                                <td class="w-25">
                                                    <img src="<?=$wiki['imageWiki'] ?>" class="img-fluid w-75 img-thumbnail" alt="image">
                                                </td>
                                                <td><?= substr($wiki['content'],0,70)  ?>...</td>
                                                <td><?= $wiki['name'] ?></td> 
                                                <td>
                                                <div class="d-flex gap-2">
                                                  <a href="?idArchive=<?=$wiki['id']?>"><input type="submit" class="btn btn-danger" name="archive" value="Archiver"></a>
                                                <a href="?idNoArchive=<?=$wiki['id']?>"><input type="submit" class="btn btn-success" name="archive" value="Désarchiver"></a>  
                                                </div>    
                                                <?php var_dump($wiki['id'])  ?>
