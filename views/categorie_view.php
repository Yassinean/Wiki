...
<aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="index.php?page=dashboard" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
            ...
            <li>
                <a href="index.php?page=tag" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
            ...
            <li>
                <a href="index.php?page=categorie" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
...
<div class="p-4 sm:ml-64">
    ...
    <div class="p-4 border-2 border-blue-800 rounded-lg dark:border-blue-700 mt-3">
        <div class="flex justify-between mb-5">
            <h2 class="text-5xl mb-4">Gestion des Catégories</h2>
            <!-- Open the modal using ID.showModal() method -->
            <button class="block text-white bg-blue-700 h-12 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-3 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" onclick="my_modal_2.showModal()">Ajouter Categories</button>
            <dialog id="my_modal_2" class="modal bg-slate-700 p-4 rounded-lg">
                <div class="modal-box">
                    ...
                    <div class="modal-action">
                        <form action="index.php?page=categorie" method="post">
                            ...
                            <div class="flex justify-between">
                                ...
                                <button class="btn text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700" name="ajouterCateg">Ajouter</button>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <tbody>
                    <tr class="bg-white border-b dark:bg-white dark:border-white hover:bg-whitedark:hover:bg-white">
                        ...
                        ?>
                            <form action="index.php?page=categorie" method="post">
                    <tr class="bg-white border-b dark:bg-white dark:border-white hover:bg-whitedark:hover:bg-white">
                        <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-blue-700">
                            <p name='nameCat'><?= $cat['name']; ?></p>
                        </th>
                        <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-blue-700">
                            <p name="descCat"><?= $cat['description']; ?></p>
                        </th>
                        <td class="px-6 py-4 flex flex-row justify-evenly">
                            <button class="font-medium text-orange-700 dark:text-orange-500 hover:underline" name="editCateg">
                            ...
                            <!-- Delete Button -->
                            <button class="font-medium text-red-700 dark:text-red-500 hover:underline" name="deleteCateg">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
