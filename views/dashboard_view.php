...
<body>
    ...
    <div class="p-4 sm:ml-64">
        <div id="general"></div>
        <!-- Statistique general -->
        <div class="p-4 border-2 border-blue-800 rounded-lg mt-3">
                            ...
                            <form method="dialog">
                                <div class="grid gap-4 mb-4 grid-cols-2">
                                    <div class="col-span-2">
                                        <label for="titre" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tag</label>
                                ...
                                <div class="flex justify-between">
                                    ...
                                    <button class="btn text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">Ajouter</button>
                                </div>
                            </form>
                        </div>
                    </div>
                    ...
                    <tbody>
                        <tr class="bg-white border-b dark:bg-white dark:border-white hover:bg-whitedark:hover:bg-white">
                            ...
                            <td class="px-6 py-4 flex flex-row justify-evenly">
                                <a href="#" class="font-medium text-orange-700 dark:text-orange-500 hover:underline">
                                ...
                                <a href="#" class="font-medium text-red-700 dark:text-red-500 hover:underline">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
