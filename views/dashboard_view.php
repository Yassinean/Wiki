        ...
        <div class="p-4 border-2 border-blue-800 rounded-lg dark:border-blue-700 mt-3">
            ...
            <div class="flex justify-evenly gap-4 mb-4">
                ...
                <div class="flex flex-col">
                    <!-- Modal toggle -->
                    <button data-modal-target="crud-modal" data-modal-toggle="crud-modal" class="block text-white bg-blue-700 mx-auto hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">
                        +Ajouter
                    </button>
                    <!-- Main modal -->
                    ...
                    <!-- modal end -->
                    <button class="inline-flex items-center px-4 py-2 my-2 bg-gray-200 hover:bg-gray-300 text-gray-800 text-sm font-medium rounded-md">
